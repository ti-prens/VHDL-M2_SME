...
TOP_LEVEL_NAME="nios_mcu"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/prince/intelFPGA_lite/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_mcu.vhd"
fi
